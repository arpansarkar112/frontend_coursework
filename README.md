...
## Part 1: Coursework (SaaS Landing Page)
...
3. Open the `index.html` file in web browser, or use the "Live Server" extension in VS Code.

### Technologies Used
* **HTML5 & CSS3:** Semantic markup, CSS Grid, Flexbox, custom variables, and media queries.
* **JavaScript:** DOM manipulation for the interactive FAQ accordion and mobile menu.
* **Credits:** Built following the SaaS Landing Page tutorial by Brad Traversy ([saas-landing-page](https://github.com/bradtraversy/saas-landing-page.git)).
